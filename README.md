...
Runs the Flask API at port 5000.\
Open [http://localhost:5000/api](http://localhost:5000/api) to seperatly view it in your browser (most of the times there will be no output).

When you make changes in the Code and save them, the Console will detect this and reload
